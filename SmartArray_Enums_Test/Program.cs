...
namespace SmartArray_Test
{
    ...
    class SmartArray
    {
        ...
        //{
        //    for (int i = 0; i < rgNums.Length; i++) { Console.WriteLine(rgNums[i]); }
        //}
        //public bool Find(int val)
        //{
        //    for (int i = 0; i < rgNums.Length; i++)
        //    {
        //        if (rgNums[i] == val) { return true; }
        //    }
        //    return false;
        //}
        #endregion
        //// Running time for this method:
        // O(1) this is an example of array access.
        //// Explanation (Why did you chose that running time?):
        public ErrorCode SetAtIndex(int idx, int val)
        {
            if (idx < 0)
                return ErrorCode.Underflow;
            else if (idx >= rgNums.Length)
        ...
        //// Running time for this method:
        // O(1) you are checking a single elemtn in an array and 
        // returning it.
        //// Explanation (Why did you chose that running time?):
        ...
        //// Running time for this method:
        // O(N) because you are accessing every element in an array
        //// Explanation (Why did you chose that running time?):
        public void PrintAllElements()
        {
            for (int i = 0; i < rgNums.Length; i++)
        ...
        //// Running time for this method:
        // O(N) because it is a loop that good from 0 to N
        //// Explanation (Why did you chose that running time?):
        public bool Find(int val)
        {
            for (int i = 0; i < rgNums.Length; i++)
